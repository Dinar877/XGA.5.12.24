function turtle_bossintro_spin() {
	
	//LEFT
	//START SPIN
	if (sprite_index = spr_boss_turtle_left) && (state = turtle_bossintro_spin)
	{
	...
	if (sprite_index = spr_boss_turtle_right) && (state = turtle_bossintro_spin)
	{
