function map_init2() {
	...
	for(global.checkmapx=floor(x/240);global.checkmapx<room_width;global.checkmapx+=240) 
	{
		for(global.checkmapy=floor(y/160);global.checkmapy<room_height;global.checkmapy+=160) 
		{
			var inst_map = (instance_position(global.checkmapx,global.checkmapy,obj_mapchecker1));
