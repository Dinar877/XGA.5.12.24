function bullet_homing_chargeblast() {
	with(obj_player)
	{
	...
	//standing
	    ...
	    if sprite_index = spr_shoot_left
	    {
	        ...
	        {
	            sprite_index = spr_HOMING_charged_blast_left;
	            x = obj_player.x-22
	            y = obj_player.y-5
	        }    
	    }
	    if sprite_index = spr_shoot_right
	    {
	        with(obj_chargeblast_effect)
	        {
	            sprite_index = spr_HOMING_charged_blast_right;
	            x = obj_player.x+20
	            y = obj_player.y-5
	        }    
	    }
	    ...
	    if sprite_index = spr_shoot_trueup_left
	    {
	        with(obj_chargeblast_effect)
	        {
	            sprite_index = spr_HOMING_charged_blast_TUL;
	            x = obj_player.x-3
	            y = obj_player.y-30
	        }    
	    }
	    if sprite_index = spr_shoot_trueup_right
	    {
	        with(obj_chargeblast_effect)
	        {
	            sprite_index = spr_HOMING_charged_blast_TUR;
	            x = obj_player.x+2
	            y = obj_player.y-30
	        }    
	    }
	    ...
	    if sprite_index = spr_shoot_upleft
	    {
	        with(obj_chargeblast_effect)
	        {
	            sprite_index = spr_HOMING_charged_blast_upleft;
	            x = obj_player.x-15
	            y = obj_player.y-24
	        }    
	    }
	    if sprite_index = spr_shoot_upright
	    {
	        with(obj_chargeblast_effect)
	        {
	            sprite_index = spr_HOMING_charged_blast_upright;
	            x = obj_player.x+14
	            y = obj_player.y-24
	        }    
	    }
	    ...
	    if sprite_index = spr_shoot_downleft
	    {
	        with(obj_chargeblast_effect)
	        {
	            sprite_index = spr_HOMING_charged_blast_downleft;
	            x = obj_player.x-18
	            y = obj_player.y+7
	        }    
	    }
	    if sprite_index = spr_shoot_downright
	    {
	        with(obj_chargeblast_effect)
	        {
	            sprite_index = spr_HOMING_charged_blast_downright;
	            x = obj_player.x+19
	            y = obj_player.y+9
	        }    
	    }
	    ...
	    if sprite_index = spr_shoot_Truedown_left
	    {
	        with(obj_chargeblast_effect)
	        {
	            sprite_index = spr_HOMING_charged_blast_TDL;
	            x = obj_player.x-5;
	            y = obj_player.y+15;
	        }    
	    }
	    if sprite_index = spr_shoot_Truedown_right
	    {
	        with(obj_chargeblast_effect)
	        {
	            sprite_index = spr_HOMING_charged_blast_TDR;
	            x = obj_player.x+5;
	            y = obj_player.y+15;
	        }    
	    }
