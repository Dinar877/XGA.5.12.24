function bullet_burn_chargedshot() {
	if (stopper_bullet = 1)
	{
	    ...
	    with(obj_blast_effect)
	    {
		    ...
		    if (sprite_index = spr_BURN_shotleft)
		    {
		        with(global.bullet)
		        {
		            if (shootlimit = 0)
		            {
			            sprite_index = spr_BURN_Charged_left;
			            hspd = -10;
			            vspd = 0;
			            shootlimit = 1;
		    ...
		    else if (sprite_index = spr_BURN_shotright)
		    {
		        with(global.bullet)
		        {
		            if (shootlimit = 0)
		            {
		            sprite_index = spr_BURN_Charged_right;
		            hspd = 10;
		            vspd = 0;
		            shootlimit = 1;
					if (global.beam_spread_available = 1)
		    ...
		    else if (sprite_index = spr_BURN_shotup)
		    {
		        with(global.bullet)
		        {
		            if (shootlimit = 0)
		            {
		            sprite_index = spr_BURN_Charged_up;
		            hspd = 0;
		            vspd = -10;
		            shootlimit = 1;
					if (global.beam_spread_available = 1)
		    ...
		    else if (sprite_index = spr_BURN_shotdown)
		    {
		        with(global.bullet)
		        {
		            if (shootlimit = 0)
		            {
		            sprite_index = spr_BURN_Charged_down;
		            hspd = 0;
		            vspd = 10;
		            shootlimit = 1;
					if (global.beam_spread_available = 1)
		    ...
		    else if (sprite_index = spr_BURN_shotupright)
		    {
		        with(global.bullet)
		        {
		            if (shootlimit = 0)
		            {
		            sprite_index = spr_BURN_Charged_upright;
		            hspd = 10;
		            vspd = -10;
		            shootlimit = 1;
						if (global.beam_spread_available = 1)
		    ...
		    else if (sprite_index = spr_BURN_shotupleft)
		    {
		        with(global.bullet)
		        {
		            if (shootlimit = 0)
		            {            
		            sprite_index = spr_BURN_Charged_upleft;
		            hspd = -10;
		            vspd = -10;
		            shootlimit = 1;
					if (global.beam_spread_available = 1)
		    ...
		    else if (sprite_index = spr_BURN_shotdownright)
		    {
		        with(global.bullet)
		        {
		            if (shootlimit = 0)
		            {
		            sprite_index = spr_BURN_Charged_downright;
		            hspd = 10;
		            vspd = 10;
		            shootlimit = 1;
					if (global.beam_spread_available = 1)
		    ...
		    else if (sprite_index = spr_BURN_shotdownleft)
		    {
		        with(global.bullet)
		        {
		            if (shootlimit = 0)
		            {
		            sprite_index = spr_BURN_Charged_downleft;
		            hspd = -10;
		            vspd = 10;
		            shootlimit = 1;
					if (global.beam_spread_available = 1)
