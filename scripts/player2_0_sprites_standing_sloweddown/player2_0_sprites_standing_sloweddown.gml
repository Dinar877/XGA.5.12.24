function player2_0_sprites_standing_sloweddown() {
	with (obj_player)
	{
	...
	//global.aiming_down
	    if (global.aiming_up = 0) && (global.aiming_trueup = 0) && (global.aiming_down = 0) && (global.turning = 0) && (global.aiming_truedown = 1)
	    {
	        ...
	        //jumping-shoot
	        if (state = Fall_shoot) && (global.facingDir = -1)
	        {
	            with (object_player2_0_sprites)
	            {
	        ...
	        else if (state = Fall_shoot) && (global.facingDir = 1)
	        {
	            with (object_player2_0_sprites)
	            {
	...
	//jumping-spin
		...
		/*
	    //jumping-screwattack
	    if ((state = Jumping) or (state= Falling)) && (global.facingDir = -1) && (global.jumpingdm = 1) && (state != Wall_jump) && (global.screwjump > 0) && (obj_player.enemy_slowdownswitch == 0)
	    {
	        with (object_player2_0_sprites)
	        {
	    ...
	    else if ((state = Jumping) or (state= Falling)) && (global.facingDir = 1) && (global.jumpingdm = 1) && (state != Wall_jump) && (global.screwjump > 0) && (obj_player.enemy_slowdownswitch == 0)
	    {
	        with (object_player2_0_sprites)
	        {
	    ...
	    //jumping-spacejump
	    if ((state = Jumping) or (state= Falling)) && (global.facingDir = -1) && (global.jumpingdm = 1) && (state != Wall_jump) && (global.spacejump = 1) && (global.screwjump = 0) && (obj_player.enemy_slowdownswitch == 0)
	    {
	        with (object_player2_0_sprites)
	        {
	    ...
	    else if ((state = Jumping) or (state= Falling)) && (global.facingDir = 1) && (global.jumpingdm = 1) && (state != Wall_jump) && (global.spacejump = 1) && (global.screwjump = 0) && (obj_player.enemy_slowdownswitch == 0)
	    {
	        with (object_player2_0_sprites)
	        {
		...
		if (global.facingDir = -1) && ((state = Falling_Dashing2_hydrodash) or (state = Jump_after_Dashing_hydrodash)) && (obj_player.enemy_slowdownswitch = 1) // && (global.spacejump = 1)
	    {
	        with (object_player2_0_sprites)
	        {
	    ...
	    else if (global.facingDir = 1) && ((state = Falling_Dashing2_hydrodash) or (state = Jump_after_Dashing_hydrodash)) && (obj_player.enemy_slowdownswitch = 1) // && (global.spacejump = 1)
	    {
	        with (object_player2_0_sprites)
	        {
