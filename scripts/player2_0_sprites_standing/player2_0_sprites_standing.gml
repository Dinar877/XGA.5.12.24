function player2_0_sprites_standing() {
	...
	if (obj_player.state != Climb_up_ledge) && (obj_player.state != Ledge_grab) 
	&& (obj_player.state != Wall_jump) 
	&& ((global.image_speed_lockdown = 1) or (global.hang = 0))
	{
		y = obj_player.y+1
		x = obj_player.x
	}
