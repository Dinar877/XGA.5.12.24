function Moving_Toad_left_knockback() {
	var stop4 = 0;
	...
	//empty jump
	if (!place_meeting(x+(hspd*7),y+1,obj_block)) && (!place_meeting(x+(hspd),y,obj_slope1_left)) && (!place_meeting(x-(hspd),y,obj_slope1_left))
	 && (!place_meeting(x+(hspd),y,obj_slope1_right)) && (!place_meeting(x-(hspd),y,obj_slope1_right))
	{
	                while(place_meeting(x+(hspd*7),y+1,obj_block)) && (!place_meeting(x+facing,y,obj_slope1_left)) && (!place_meeting(x-facing,y,obj_slope1_left))
	                ...
	                if (!place_meeting(x+(hspd*7),y+1,obj_block)) && (!place_meeting(x+facing,y,obj_slope1_left)) && (!place_meeting(x-facing,y,obj_slope1_left))
	...
	if (!place_meeting(x+(hspd),y,obj_block)) && (!place_meeting(x+(hspd),y,obj_slope1_left)) && (!place_meeting(x+(hspd),y,obj_slope1_right))
	 ...
	 && (stop4 = 0)&& (place_meeting(x+(hspd*7),y+1,obj_block)) && !((place_meeting(x-1,y,obj_slope1_right)) && (place_meeting(x,y+1,obj_block)))
	            {
	                x -= facing*hspd;
	            }
