function Moving_Toad_right_knockback() {
	var stop4 = 0;
	 ...
	 && (!place_meeting(x+(hspd),y,obj_slope1_right)) && (!place_meeting(x-(hspd),y,obj_slope1_right))
	{
	                ...
	                if (!place_meeting(x+(hspd*7),y+1,obj_block)) && (!place_meeting(x+facing,y,obj_slope1_left)) && (!place_meeting(x-facing,y,obj_slope1_right))
