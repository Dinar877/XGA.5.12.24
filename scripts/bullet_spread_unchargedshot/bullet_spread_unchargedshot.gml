function bullet_spread_unchargedshot() {
	if (stopper_bullet = 1)
	{
	...
	audio_sound_gain(snd,0,600)
	    ...
	    else if (sprite_index = spr_Spread_blasteffect_up)
	    {
	        with(global.bullet)
	        {
	            if (shootlimit = 0)
	            {
	            sprite_index = spr_bulletSpread_charge1_up;
	            hspd = 0;
	            vspd = -10;
	            shootlimit = 1;
					var instbullet1 = instance_create_layer(obj_blast_effect.x,obj_blast_effect.y,layer_get_id("Inst_level_0"),obj_bullet_side1)
	    ...
	    else if (sprite_index = spr_Spread_blasteffect_down)
	    {
	        with(global.bullet)
	        {
	            if (shootlimit = 0)
	            {
	            sprite_index = spr_bulletSpread_charge1_down;
	            hspd = 0;
	            vspd = 10;
	            shootlimit = 1;
					var instbullet1 = instance_create_layer(obj_blast_effect.x,obj_blast_effect.y,layer_get_id("Inst_level_0"),obj_bullet_side1)
	    ...
	    else if (sprite_index = spr_Spread_blasteffect_upright)
	    {
	        with(global.bullet)
	        {
	            if (shootlimit = 0)
	            {
	            sprite_index = spr_bulletSpread_charge1_upright;
	            hspd = 10;
	            vspd = -10;
	            shootlimit = 1;
					var instbullet1 = instance_create_layer(obj_blast_effect.x,obj_blast_effect.y,layer_get_id("Inst_level_0"),obj_bullet_side1)
	    ...
	    else if (sprite_index = spr_Spread_blasteffect_upleft)
	    {
	        with(global.bullet)
	        {
	            if (shootlimit = 0)
	            {            
	            sprite_index = spr_bulletSpread_charge1_upleft;
	            hspd = -10;
	            vspd = -10;
	            shootlimit = 1;
					var instbullet1 = instance_create_layer(obj_blast_effect.x,obj_blast_effect.y,layer_get_id("Inst_level_0"),obj_bullet_side1)
	    ...
	    else if (sprite_index = spr_Spread_blasteffect_downright)
	    {
	        with(global.bullet)
	        {
	            if (shootlimit = 0)
	            {
	            sprite_index = spr_bulletSpread_charge1_downright;
	            hspd = 10;
	            vspd = 10;
	            shootlimit = 1;
					var instbullet1 = instance_create_layer(obj_blast_effect.x,obj_blast_effect.y,layer_get_id("Inst_level_0"),obj_bullet_side1)
	    ...
	    else if (sprite_index = spr_Spread_blasteffect_downleft)
	    {
	        with(global.bullet)
	        {
	            if (shootlimit = 0)
	            {
	            sprite_index = spr_bulletSpread_charge1_downleft;
	            hspd = -10;
	            vspd = 10;
	            shootlimit = 1;
					var instbullet1 = instance_create_layer(obj_blast_effect.x,obj_blast_effect.y,layer_get_id("Inst_level_0"),obj_bullet_side1)
