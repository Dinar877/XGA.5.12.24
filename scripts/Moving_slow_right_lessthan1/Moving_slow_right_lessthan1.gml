function Moving_slow_right_lessthan1() {
	...
	//going up left slope
	if ((place_meeting((x)+2,(y),obj_slope1_left)) or (place_meeting((x)+1,(y),obj_slope1_left)))
	&& (!place_meeting((x),(y)+1,obj_block))
	&& ((position_meeting(bbox_right+2,bbox_bottom-1,obj_slope1_left)) or (position_meeting(bbox_right+2,bbox_bottom,obj_slope1_left)))
	&& (stop4 == 0)
	        {
	                y -= moveX; //up
	                x += moveX; //right
	...
	//going up from left slope to block, part 1
	if (position_meeting(bbox_right,bbox_bottom+1,obj_slope1_left)) 
	&& (!position_meeting(bbox_right+1,bbox_bottom+1,obj_block))
	&& (!position_meeting(bbox_right+2,bbox_bottom-1,obj_slope1_left))
	&& (stop4 == 0)
	        {
	                if (!place_meeting((x)+2,(y),obj_block)) && (!place_meeting((x),(y)+2,obj_slope1_left)) 
					&& (!position_meeting(bbox_right+2,bbox_bottom-1,obj_slope1_left)) && (!position_meeting(bbox_right+1,bbox_bottom+1,obj_block))
					&& (stop4 == 0)
					{
						x += moveX; //right
					...
					if (place_meeting((x)+2,(y),obj_slope1_left)) && (place_meeting((x)+2,(y),obj_block))
					&& (position_meeting(bbox_right,bbox_bottom+1,obj_slope1_left)) && (!position_meeting(bbox_right+1,bbox_bottom+1,obj_block))
					&& (!position_meeting(bbox_right+2,bbox_bottom-1,obj_slope1_left))
	                && (stop4 == 0)
					{
		                x += moveX; //right
	...
	//moving from a left slope to a block, then fully onto a block
	if (!place_meeting((x)+2,(y),obj_slope1_left)) && (!place_meeting((x)+2,(y),obj_block))
	&& (place_meeting((x),(y)+2,obj_slope1_left)) && (position_meeting(bbox_right+2,bbox_bottom+2,obj_block))
	&& (place_meeting(bbox_right,bbox_bottom+2,obj_slope1_left))
	&& (!position_meeting(bbox_right+2,bbox_bottom-1,obj_slope1_left)) && (!position_meeting(bbox_right+2,bbox_bottom,obj_slope1_left))
	&& (stop4 == 0)
	        {
				x += moveX; //right
	...
	if (place_meeting((x)+2,(y),obj_slope1_left)) && (!place_meeting((x),(y)+1,obj_slope1_left))
	&& (!place_meeting((x)+2,(y),obj_block)) && (place_meeting(x,(y)+1,obj_block))
	&& (stop4 == 0)
	{
	        if (place_meeting((x)+2,(y),obj_slope1_left)) && (!place_meeting((x),(y)+1,obj_slope1_left))
			&& (!place_meeting((x)+2,(y),obj_block)) && (place_meeting(x,(y)+1,obj_block))
			&& (!place_meeting((x)+moveX,(y),obj_slope1_left))
			&& (stop4 == 0)
	        {    
				x += moveX; //right
			...
			else if (place_meeting((x)+2,(y),obj_slope1_left)) && (!place_meeting((x),(y)+1,obj_slope1_left))
			&& (!place_meeting((x)+2,(y),obj_block)) && (place_meeting(x,(y)+1,obj_block))
			&& (place_meeting((x)+moveX,(y),obj_slope1_left))
			&& (stop4 == 0)
	        {    
	...
	if ((position_meeting(bbox_left-1,bbox_bottom,obj_slope1_right)) or (position_meeting(bbox_left-1,bbox_bottom+1,obj_slope1_right)))
	&& (!place_meeting(x,(y)+1,obj_block))
	&& (!place_meeting((x)+3,(y)+2,obj_slope1_right))
	...
	else if ((position_meeting(bbox_left-1,bbox_bottom,obj_slope1_right)) or (position_meeting(bbox_left-1,bbox_bottom+1,obj_slope1_right)))
	&& (place_meeting((x),(y)+1,obj_block))
	&& (!place_meeting((x)+3,(y)+2,obj_slope1_right))
	&& (place_meeting((x)+2,(y)+3,obj_block))
	&& (stop4 == 0)
	...
	//move away from right slope, once fully gone down from right slope to block
	if (!position_meeting(bbox_left-1,bbox_bottom+1,obj_slope1_right)) 
	&& (place_meeting((x)-moveX+subspeed,(y),obj_slope1_right))
	&& (place_meeting((x),(y)+1,obj_block))
	&& (!place_meeting((x)+3,(y)+2,obj_slope1_right))
	&& (place_meeting((x)+2,(y)+3,obj_block))
	&& (stop4 == 0)
	...
	&& ((!position_meeting(bbox_left-1,bbox_bottom+1,obj_slope1_right)) or (!position_meeting(bbox_left-2,bbox_bottom+1,obj_slope1_right))) //check 2 pixels behind us, if either one isn't a slope, then continue
	&& (!position_meeting(bbox_left-1,bbox_bottom,obj_slope1_right)) 
	&& (!position_meeting(bbox_left-2,bbox_bottom-1,obj_slope1_right))
	&& (!position_meeting(bbox_left-1,bbox_bottom-1,obj_slope1_right))
	&& ((position_meeting(bbox_left,bbox_bottom+1,obj_slope1_right)) or (position_meeting(bbox_left,bbox_bottom+2,obj_slope1_right)) //check 2 pixels below our bottom right corner
	or (position_meeting(bbox_left,bbox_bottom+1,obj_slope1_right)) or (position_meeting(bbox_left,bbox_bottom+2,obj_slope1_right)))
	&& ((position_meeting(bbox_left-1,bbox_bottom+1,obj_block)) or (position_meeting(bbox_left-2,bbox_bottom+1,obj_block))) //check 2 pixels behind us, if either one is a block, then continue
	&& (stop4 == 0)
	   {
	        x+= moveX; //right
			y+= moveX; //down
	...
	&& (!position_meeting(bbox_left-1,bbox_bottom,obj_slope1_right)) && (!position_meeting(bbox_left-1,bbox_bottom,obj_slope1_right))
	&& (position_meeting(bbox_left+1,bbox_bottom+1,obj_slope1_right))
	...
	&& (stop4 == 0)
	{
		...
		or (place_meeting(x+(sign(moveX)*2),y,obj_block)))
		&& (!place_meeting(x+moveX,y,obj_slope1_left)) 
	...
	&& ((place_meeting(x-3,y,obj_slope1_left))
	or (place_meeting(x+3,y,obj_slope1_right))
	or (place_meeting(x-3,y,obj_newslope_left))
	or (place_meeting(x+3,y,obj_newslope_left)))
	&& (stop4 == 0)
	{
	    while (!place_meeting(x+sign(moveX),y,obj_block)) 
	...
	&& (!position_meeting(bbox_left+(moveX),bbox_bottom+1,obj_block))  //no block under us along our current path
	...
	&& (stop4 == 0)
	{
		...
		while (position_meeting(bbox_left+sign(moveX),bbox_bottom+2,obj_block)) 
		...
		//stop object at exactly 1 pixel remaining on block edge, no slopes below us
...
/////////////////////////////MOVE FORWARD
	...
	//if there's nothing there, floor(y)ou're moving and floor(y)ou're on top of a collision block
