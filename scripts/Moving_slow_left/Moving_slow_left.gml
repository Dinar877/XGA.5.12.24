function Moving_slow_left() {
	var stop4 = 0;
	///left slopes
	///////////////////////////////////////////////////////going down

	//going down left slope
	if (place_meeting(x+1-hspd,y,obj_slope1_left)) && (!place_meeting(x+1,y-hspd,obj_block)) && (!place_meeting(x+1,y,obj_block)) && (hspd < 0)
	        {
					y-= hspd;
	                x+= hspd;
	        } 
	...
	if (position_meeting(bbox_right,bbox_bottom+1,obj_slope1_left)) && (!place_meeting(x,y+1,obj_block)) && (!place_meeting(x+sign(hspd),y-sign(hspd),obj_slope1_left)) && (place_meeting(x+sign(hspd),y-sign(hspd),obj_block))
	   {
	                while (position_meeting(bbox_right,bbox_bottom+1,obj_slope1_left)) && (!place_meeting(x,y+1,obj_block))
	                {    
		                x = floor(x) + sign(hspd);
		                y = floor(y) - sign(hspd);
	                }
	...
	if (position_meeting(bbox_right+1,bbox_bottom,obj_slope1_left)) && (place_meeting(x,y+1,obj_block)) && (!place_meeting(x+(hspd)+1,y-(hspd)+1,obj_slope1_left))
	{    
		x = floor(x) + sign(hspd);
	}

	//while loop for going down from block to left slope
	if (place_meeting(x,y+1,obj_block)) && (place_meeting(x+sign(hspd),y-sign(hspd),obj_slope1_left)) && (!place_meeting(x+sign(hspd),y-sign(hspd),obj_block))
	...
	&& (!place_meeting(x+sign(hspd)-hspd,y,obj_block)) && (!place_meeting(x+1-hspd,y,obj_slope1_left))
	                {    
						x = floor(x) + sign(hspd);
		                y = floor(y) - sign(hspd);
	                }
	...
	if (place_meeting(x+sign(hspd)+hspd,y,obj_slope1_right)) && (place_meeting(x,y+1-hspd,obj_slope1_right)) && (place_meeting(x+sign(hspd)+hspd,y+sign(hspd)+1,obj_slope1_right))
	        {
	                y+= hspd;
	                x+= hspd;
	        } 
	...
	if (place_meeting(x-1+hspd,y,obj_block)) && (place_meeting(x,y+1,obj_slope1_right)) && (!place_meeting(x+sign(hspd)+hspd,y+sign(hspd)+hspd,obj_slope1_right))
	        {
	                while (place_meeting(x-1+hspd,y,obj_slope1_right)) && (place_meeting(x,y+1,obj_slope1_right))
	                {
		                x = floor(x) + sign(hspd);
		                y = floor(y) + sign(hspd);
	                }
	...
	if (!place_meeting(x-1+hspd,y,obj_slope1_right)) && (position_meeting(bbox_left,bbox_bottom+1,obj_slope1_right))
			{
				x = floor(x) + sign(hspd);
			}
		
	//going up block to right slope
	if (place_meeting(x-1+hspd,y,obj_slope1_right)) && (!place_meeting(x+sign(hspd),y,obj_block)) && (place_meeting(x,y+1,obj_block))
	        {
	                if (!place_meeting(x+sign(hspd),y,obj_block)) && (place_meeting(x-1+hspd,y,obj_slope1_right))
	                {    
	                x = floor(x) + sign(hspd);
	                }
					if (place_meeting(x-1+hspd,y,obj_slope1_right)) && (!place_meeting(x+sign(hspd),y,obj_block))
	                {    
	                x = floor(x) + sign(hspd);
					y = floor(y) + sign(hspd);
	                }
	...
	if (!place_meeting(x+sign(hspd),y,obj_block)) && (!place_meeting(x+1-hspd,y,obj_slope1_left)) && (!place_meeting(x-1+hspd,y,obj_slope1_right))
