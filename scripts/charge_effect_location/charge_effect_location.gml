function charge_effect_location() {
	with(object_player2_0_sprites)
		...
		//standing
			...
			if (sprite_index = spr_stand_left_2) && ((round(image_index)) <= 12)
			{
		        ...
		        {
					x = object_player2_0_sprites.x-19
			...
			if (sprite_index = spr_stand_upleft_2) && ((round(image_index)) <= 12)
			{
				with(obj_blast_effect)
		        {
			        ...
			        y = object_player2_0_sprites.y-24
				}
			}
			...
			else if (sprite_index = spr_stand_Trueupleft_2) && (((round(image_index)) == 13) or ((round(image_index)) == 24))
			{
		        ...
		        {
					x = object_player2_0_sprites.x-4
			        y = object_player2_0_sprites.y-30
				}
			}
			...
			else if (sprite_index = spr_stand_downleft_2) && (((round(image_index)) == 13) or ((round(image_index)) == 24))
			{
		        ...
		        {
					x = object_player2_0_sprites.x-18
			        y = object_player2_0_sprites.y+3
				}
			}
		...
		//land upleft
		if (sprite_index = spr_land_upleft)
		{
			if (round(image_index) == 0)
			{
				with(obj_blast_effect)
			...
			else if (round(image_index) == 1)
			{
			    ...
			    {
					x = object_player2_0_sprites.x-15;
			        y = object_player2_0_sprites.y-19;
				}
			}
			else if (round(image_index) == 2)
			{
			    ...
			    {
					x = object_player2_0_sprites.x-15;
			        y = object_player2_0_sprites.y-20;
				}
			}
			else if (round(image_index) == 3)
			{
			    ...
			    {
					x = object_player2_0_sprites.x-15;
			        y = object_player2_0_sprites.y-21;
				}
			}
			else if (round(image_index) == 4)
			{
		...
		//land T.upleft
		if (sprite_index = spr_land_Tupleft)
		{
			if (round(image_index) == 0)
			{
				with(obj_blast_effect)
			    {
					x = object_player2_0_sprites.x-4;
			        y = object_player2_0_sprites.y-27;
				}
			}
			else if (round(image_index) == 1)
			{
		...
		//land downleft
		if (sprite_index = spr_land_downleft)
		{
			if (round(image_index) == 0)
			{
				with(obj_blast_effect)
			...
			else if (round(image_index) == 3)
			{
			    ...
			    {
					x = object_player2_0_sprites.x-18;
			        y = object_player2_0_sprites.y+7;
				}
			}
			else if (round(image_index) == 4)
			{
		...
		#region
		//land right
		if (sprite_index = spr_land_right)
		{
			if (round(image_index) == 0)
			{
				with(obj_blast_effect)
		...
		//land upright
		if (sprite_index = spr_land_upright)
		{
			if (round(image_index) == 0)
			{
				with(obj_blast_effect)
		...
		//land T.upright
		if (sprite_index = spr_land_Tupright)
		{
			if (round(image_index) == 0)
			{
				with(obj_blast_effect)
		...
		//land downright
		if (sprite_index = spr_land_downright)
		{
			if (round(image_index) == 0)
			{
				with(obj_blast_effect)
			...
			else if (round(image_index) == 1)
			{
			    ...
			    {
					x = object_player2_0_sprites.x+18;
				    y = object_player2_0_sprites.y+11;
				}
			}
			else if (round(image_index) == 2)
			{
			    ...
			    {
					x = object_player2_0_sprites.x+18;
				    y = object_player2_0_sprites.y+10;
				}
			}
			else if (round(image_index) == 3)
			{
