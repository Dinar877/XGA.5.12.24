function scrn_roomtransition_nodoors_3() {
	if (sprite_index == -1) && (global.room_x != 1) && (global.room_transition_nodoors_3 == 1) && (deact == 0) && (global.room_y != 1)
	...
	if (global.room_y == 1) && (global.stopper_2ndscrnshot = 0) && (global.room_transition_nodoors_3 == 1) && (deact == 0) && (sprite_index == scrn)
	...
	if (global.room_transition_nodoors_3 = 1) && (global.room_x = 0) && (global.room_y = 1) && (global.stopper_2ndscrnshot = 0)
	{
	
		if (global.room_transition_nodoors_3 = 1) && (started1 = 0) && (FadeNow <= 1.0)
	    {
	        FadeNow = 0.0;
	        started1 = 1;
	    }
	    if (FadeNow <= 1.0) && (global.room_transition_nodoors_3 = 1) && (started1 = 1)
	    {
	...
	if (global.room_transition_nodoors_3 = 1) && (global.room_x = 1) && (global.room_y = 1) && (global.stopper_2ndscrnshot = 0)
	{
 		...
 		if (doorleft)
		{
			...
			if (global.room_transition_notnowR3) && (instance_exists(obj_door_border_right_3))
			{
				with(obj_player)
				{
					x = obj_door_border_right_3.x+16;
					y = obj_door_border_right_3.y+global.door_height;
		...
		else if (doorright)
		{
			...
			instance_activate_object(obj_player);
			instance_activate_object(object_player2_0_sprites);
			if (global.room_transition_notnowL3) && (instance_exists(obj_door_border_left_3))
			{
				with(obj_player)
				{
					x = obj_door_border_left_3.x-25;
					y = obj_door_border_left_3.y+global.door_height;	
	...
	if (global.room_transition_nodoors_3 = 1) && (global.room_x = 1) && (global.room_y = 1) && (global.stopper_2ndscrnshot = 1)
	{
		layer = layer_get_id("Inst_scrn")
	    depth = -100000;
		FadeNow = 1.0;
		...
		if (image_alpha = 1)
		{
			if (doorleft > 0) && (instance_exists(obj_door_border_right_3))
			{
				with(obj_player)
				{
					state = global.state
				...
				{	
					...
					{
						y = obj_door_border_right_3.y+global.door_height+1
					}
					...
					{
						y = obj_door_border_right_3.y+global.door_height-2
					}
				...
				var boby = obj_camera.y-obj_door_border_right_3.y
		
				x = obj_camera.x-160
				y = obj_camera.y-90
			}
			else if (doorright > 0) && (instance_exists(obj_door_border_left_3))
			{
				with(obj_player)
				{
					global.state = state
				...
				with(object_player2_0_sprites)
				{
					...
					if (global.jumpingdm <= 0) && (global.dash2 <= 0) && (global.dashbegin2 <= 0)
					{
						y = obj_door_border_left_3.y+global.door_height+1
					}
					else if (global.spacejump = 0) && (global.jumpingdm > 0) && (global.screwjump = 0)
					{
						y = obj_door_border_left_3.y+global.door_height+1
					...
					{
						y = obj_door_border_left_3.y+global.door_height-2
					}
					else if (global.screwjump = 1) && (global.jumpingdm > 0)
					{
						y = obj_door_border_left_3.y+global.door_height-2
				...
				var boby = obj_camera.y-obj_door_border_left_3.y
				global.ygrid = 0
				global.ygridend = 0
	...
	if (image_alpha <= 0.0) && (global.stopper_2ndscrnshot = 1) && (global.room_transition_nodoors_3 == 1) && (global.room_x = 1)
	{   
					global.room_y = 0;
	                global.room_x = 0;
