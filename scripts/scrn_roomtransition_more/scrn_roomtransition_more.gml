function scrn_roomtransition_more() {
	if (sprite_index == -1) && (global.room_x != 1) && (global.room_transition_more == 1) && (deact == 0) && (global.room_y != 1)
	{
	    with(obj_player)
		{
			image_speed_stop = 1;	
	...
	if (global.room_y == 1) && (global.stopper_2ndscrnshot = 0) && (global.room_transition_more == 1) && (deact == 0) && (sprite_index == scrn)
	{
	    depth = -100000;
	    FadeNow = 0.0;
		...
		if (doorleft)
		{
			instance_activate_object(obj_door_normal_left_more)	
		}
		else if (doorright)
		{
			instance_activate_object(obj_door_normal_right_more)	
		}
	...
	if (global.room_transition_more = 1) && (global.room_x = 0) && (global.room_y = 1) && (global.stopper_2ndscrnshot = 0) && (deact == 1)
	{
		...
		if (global.room_transition_more = 1) && (started1 = 0) && (FadeNow <= 1.0)
	    {
	        FadeNow = 0.0;
	        started1 = 1;
	    }
	    if (FadeNow <= 1.0) && (global.room_transition_more = 1) && (started1 = 1)
	    {
	...
	if (global.room_transition_more = 1) && (global.room_y = 1) && (global.stopper_2ndscrnshot = 0) && (FadeNow >= 1.0)
	&& ((global.room_transition_notnowR_more = 1) or (global.room_transition_notnowL_more = 1))
	{
	    if (doorleft)
		{
			instance_activate_object(obj_door_normal_right_more);
			...
			if (global.room_transition_notnowR_more) && (instance_exists(obj_door_normal_right_more))
			{
				with(obj_player)
				{
					x = obj_door_normal_right_more.x+30;
					y = obj_door_normal_right_more.y+global.door_height;
		...
		else if (doorright)
		{
			...
			instance_activate_object(obj_player);
			instance_activate_object(object_player2_0_sprites);
			if (global.room_transition_notnowL_more) && (instance_exists(obj_door_normal_left_more))
			{
				with(obj_player)
				{
					x = obj_door_normal_left_more.x-28;
					y = obj_door_normal_left_more.y+global.door_height;	
	...
	if (global.room_transition_more = 1) && (global.room_y = 1) && (global.stopper_2ndscrnshot = 1) && (FadeNow > 0)
	{
		//set camera and scrn object Y
		if (instance_exists(obj_camera))
		{
	...
	if (image_alpha <= 0.0) && (global.stopper_2ndscrnshot = 1) && (global.room_transition_more == 1)
	{   
					global.room_y = 0;
	                global.room_x = 0;
					...
					*/
					...
					if (instance_exists(obj_door_normal_left)) && (instance_exists(obj_door_normal_right))
					{
