/// @description Adds a new1 tile to the room, allowing customisation of its attributes, and returning its index.
/// @param background The background asset from which the new1 tile will be extracted.
/// @param left The x coordinate of the left of the new1 tile, relative to the background asset's top left corner.
/// @param top The y coordinate of the top of the new1 tile, relative to the background assets top left corner.
...
/// @returns {number} resource name for the new1 tile
function tile_add(argument0, argument1, argument2, argument3, argument4, argument5, argument6, argument7) {
	...
	// Now create a new1 tile element and add it to the layer
