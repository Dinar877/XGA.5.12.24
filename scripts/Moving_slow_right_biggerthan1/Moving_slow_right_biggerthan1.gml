function Moving_slow_right_biggerthan1() {
	...
	//going up left slope
	if ((place_meeting(x+(moveX),y,obj_slope1_left)) or (collision_line(x,bbox_bottom,x+(moveX),bbox_bottom,obj_slope1_left,false,true)))
	&& ((place_meeting(x+(moveX),y-abs(moveX)+2,obj_slope1_left)) or (collision_line(x,bbox_bottom,x+(moveX),bbox_bottom-abs(moveX)+2,obj_slope1_left,false,true)))
	...
	//going up from left slope to block
	...
	&& (stop4 = 0)
	        {
	                while ((place_meeting(x+(moveX),y,obj_slope1_left)) or (collision_line(x,bbox_bottom,x+(moveX),bbox_bottom,obj_slope1_left,false,true)))
					&& (place_meeting(x,y+2,obj_slope1_left))
	...
	if (!place_meeting(x+(moveX),y,obj_slope1_left)) && (!collision_line(x,bbox_bottom,x+moveX,bbox_bottom,obj_slope1_left,false,true))
	...
	&& (stop4 = 0)
	        {
					...
					&& (!place_meeting(x+(moveX),y,obj_block)) && (!collision_line(x,bbox_bottom,x+moveX,bbox_bottom,obj_block,false,true))
					&& ((place_meeting(x+(moveX),y,obj_slope1_left)) or (collision_line(x,bbox_bottom,x+(moveX),bbox_bottom,obj_slope1_left,false,true)))
					&& (stop4 = 0)
	                {    
						x = (x) + (moveX);
	...
	if ((position_meeting(bbox_left,bbox_bottom,obj_slope1_right)) or (position_meeting(bbox_left,bbox_bottom+1,obj_slope1_right))) 
	&& (!place_meeting(x,y+1,obj_block)) 
	&& (!place_meeting(x+(moveX),y+(moveX)+1,obj_slope1_right)) 
	//&& (!collision_line(x,bbox_bottom,x+(moveX),bbox_bottom+(moveX)+1,obj_slope1_right,false,true))
	&& ((place_meeting(x+(moveX),y+(moveX),obj_block)) 
	...
	&& (stop4 = 0)
	   {
	                while ((position_meeting(bbox_left,bbox_bottom,obj_slope1_right)) or (position_meeting(bbox_left,bbox_bottom+1,obj_slope1_right))) 
					&& (!place_meeting(x,y+1,obj_block)) 
					&& (!position_meeting(bbox_right+1,bbox_top,obj_block))
	                && (hspdCounter > 0)
					{    
	...
	if (position_meeting(bbox_left-1,bbox_bottom,obj_slope1_right)) && (place_meeting(x,y+2,obj_block)) && (!place_meeting(x,y+2,obj_slope1_right)) 
	&& (!place_meeting(x+(moveX),y+(moveX)+1,obj_slope1_right)) && (!collision_line(x,bbox_bottom,x+(moveX),bbox_bottom+(moveX)+1,obj_slope1_right,false,true))
	&& (stop4 = 0)
	{    
		if (hspdCounter == moveX)
		{
	...
	&& ((place_meeting(x+(moveX),y+(moveX)+1,obj_slope1_right)) or (collision_line(x,bbox_bottom,x+(moveX),bbox_bottom+(moveX)+1,obj_slope1_right,false,true)))
	&& (!place_meeting(x+(moveX),y+(moveX),obj_block)) && (!collision_line(x,bbox_bottom,x+(moveX),bbox_bottom+(moveX),obj_block,false,true))
	&& (!position_meeting(bbox_left,bbox_bottom+1,obj_slope1_right))
	&& (stop4 = 0)
	   {
					//get to edge of block
					...
					//move down once at edge of block
					if (position_meeting(bbox_left,bbox_bottom+1,obj_slope1_right)) && (position_meeting(bbox_left-1,bbox_bottom+1,obj_block)) 
					&& (!place_meeting(x+(moveX),y,obj_block)) && (!collision_line(x,bbox_bottom,x+moveX,bbox_bottom,obj_block,false,true))
					&& ((place_meeting(x+(moveX),y+(moveX)+1,obj_slope1_right)) or (collision_line(x,bbox_bottom,x+(moveX),bbox_bottom+(moveX)+1,obj_slope1_right,false,true)))
					&& (stop4 = 0)
	                {    
	...
	if (position_meeting(bbox_left,bbox_bottom+2,obj_slope1_right)) && (position_meeting(bbox_left-1,bbox_bottom+2,obj_block)) 
	&& (!place_meeting(x+(moveX),y,obj_block)) && (!collision_line(x,bbox_bottom,x+moveX,bbox_bottom,obj_block,false,true))
	&& ((place_meeting(x+(moveX),y+(moveX)+1,obj_slope1_right)) or (collision_line(x,bbox_bottom,x+(moveX),bbox_bottom+(moveX)+1,obj_slope1_right,false,true)))
	&& (stop4 = 0)
	                {    
	...
	//normal collision block - if block detected and not slope in front of you
	if ((place_meeting(x+moveX,y,obj_block)) 
	or (place_meeting(x+moveX,y-moveX,obj_block)) 
	or (collision_line(x,bbox_bottom,x+moveX,bbox_bottom-moveX,obj_block,false,true)))
	...
	&& (!place_meeting(x+(moveX),y+moveX,obj_block)) && (!collision_line(x,bbox_bottom,x+moveX,bbox_bottom+moveX,obj_block,false,true)) //no block under us along our current path
	&& (!position_meeting(bbox_left+moveX,bbox_bottom+moveX,obj_block))  //no block under us along our current path
