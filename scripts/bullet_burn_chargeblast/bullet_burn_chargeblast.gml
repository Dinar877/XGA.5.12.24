function bullet_burn_chargeblast() {
	with(obj_player)
	{
	...
	//standing
	    ...
	    if sprite_index = spr_shoot_left
	    {
	        ...
	        {
	            sprite_index = spr_BURN_chargeblast_left;
	            x = obj_player.x-22
	            y = obj_player.y-5
	        }    
	    }
	    if sprite_index = spr_shoot_right
	    {
	        with(obj_chargeblast_effect)
	        {
	            sprite_index = spr_BURN_chargeblast_right;
	            x = obj_player.x+20
	            y = obj_player.y-5
	        }    
	    }
	    ...
	    if sprite_index = spr_shoot_trueup_left
	    {
	        with(obj_chargeblast_effect)
	        {
	            sprite_index = spr_BURN_chargeblast_TUleft;
	            x = obj_player.x-3
	            y = obj_player.y-30
	        }    
	    }
	    if sprite_index = spr_shoot_trueup_right
	    {
	        with(obj_chargeblast_effect)
	        {
	            sprite_index = spr_BURN_chargeblast_TUright;
	            x = obj_player.x+2
	            y = obj_player.y-30
	        }    
	    }
	    ...
	    if sprite_index = spr_shoot_upleft
	    {
	        with(obj_chargeblast_effect)
	        {
	            sprite_index = spr_BURN_chargeblast_Uleft;
	            x = obj_player.x-15
	            y = obj_player.y-24
	        }    
	    }
	    if sprite_index = spr_shoot_upright
	    {
	        with(obj_chargeblast_effect)
	        {
	            sprite_index = spr_BURN_chargeblast_Uright;
	            x = obj_player.x+14
	            y = obj_player.y-24
	        }    
	    }
	    ...
	    if sprite_index = spr_shoot_downleft
	    {
	        with(obj_chargeblast_effect)
	        {
	            sprite_index = spr_BURN_chargeblast_Dleft;
	            x = obj_player.x-18
	            y = obj_player.y+7
	        }    
	    }
	    if sprite_index = spr_shoot_downright
	    {
	        with(obj_chargeblast_effect)
	        {
	            sprite_index = spr_BURN_chargeblast_Dright;
	            x = obj_player.x+19
	            y = obj_player.y+9
	        }    
	    }
	    ...
	    if sprite_index = spr_shoot_Truedown_left
	    {
	        with(obj_chargeblast_effect)
	        {
	            sprite_index = spr_BURN_chargeblast_TDleft;
	            x = obj_player.x-5;
	            y = obj_player.y+15;
	        }    
	    }
	    if sprite_index = spr_shoot_Truedown_right
	    {
	        with(obj_chargeblast_effect)
	        {
	            sprite_index = spr_BURN_chargeblast_TDright;
	            x = obj_player.x+5;
	            y = obj_player.y+15;
	        }    
	    }
