...
{
	instance_create_layer(96,32,layer_get_id("Inst_level_0"),obj_BUTTONREMAPPING);
}
*/
...
{
	instance_create_layer(__view_get( e__VW.XView, 0 )+96,__view_get( e__VW.YView, 0 )+32,layer_get_id("Inst_healthui"),obj_screensize);
}
