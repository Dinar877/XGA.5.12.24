...
doors_touchingplayer_right(obj_door_normal_right_3, obj_door_normal_left_3, global.room_transition_3)
/*
...
if (stopper1 == 1) && (doit1 != 1) && (global.room_transition_3 = 0)
{
    global.room_transition_3 = 1;
    backend = 0;
    doit1 = 1;
}
...
if (global.room_transition_3 == 1) && (n == 0) && (stopper1 == 1) && (backend == 0)
{
...
doors_movingplayer_right(global.room_transition_3, global.doorpath7);
