...
text1 = " S.SHOCKWAVE";
text2 = " NOW THE S.SHOCK WAVES OPEN WHITE EYED GRAY DOORS.  SELECT WITH " + string(L2) + "/" + string(R2) + " TO CYCLE BETWEEN ABILITIES, ACTIVATING THE CURRENT ONE HIGHLIGHTED.";
