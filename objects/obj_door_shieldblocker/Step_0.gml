...
//door direction
if (sprite_index = spr_doorstopper_left_original_shield)
{
	doorDirection = -1;
}
else if (sprite_index = spr_doorstopper_right_original_shield)
{
	doorDirection = 1;
}
...
if (hp <= 0)
{
	...
	with(obj_blockerdoor_piece)
	{
		...
		if (randNum == 0)
		{
			sprite_index = spr_doorstopper_shield_piece_1
		}
		else if (randNum == 1)
		{
			sprite_index = spr_doorstopper_shield_piece_2
		}
		else if (randNum == 2)
		{
			sprite_index = spr_doorstopper_shield_piece_3
		}
		else if (randNum == 3)
		{
			sprite_index = spr_doorstopper_shield_piece_4
		}
	}
