...
borderdoors_touchingplayer_right()
...
borderdoors_movingplayer_right(global.doorpath7)
...
if (started > 0)
{
	...
	with(obj_scrn_roomtransition)
	{
	    if (FadeNow >= 1.0) && (global.room_transition_nodoors = 1) && (global.room_x = 0) && (global.room_y = 1) && (global.stopper_2ndscrnshot = 0) && (global.mapgrid_1x1 == 0)
	    {
	        with(object_player2_0_sprites)
	        {
		...
		else if (FadeNow >= 1.0) && (global.room_transition_nodoors = 1) && (global.room_x = 0) && (global.room_y = 1) && (global.stopper_2ndscrnshot = 0) && (global.mapgrid_1x1 == 1)
	    {
	        with(object_player2_0_sprites)
	        {
		            if (x < obj_camera_stopperL.x + 295)
