...
if (global.invisibility_state = 1)
{
	sprite_index = spr_super_item_invisibility_extension	
}
...
tex = 0
tex2 = 0
text1 = " INVISIBILITY AMMO EXTENSION"
text2 = 0;
...
else text2 = " INCREASES INVISIBILITY AMMO BY +3.";
