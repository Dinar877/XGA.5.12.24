...
audio_stop_sound(snd_player_screwattack)
	...
	with(tex2)
	{
		text = " INCREASES YOUR MAXIMUM HEALTH ENERGY BY 100 UNITS.";
		spd = 1;
		spawnerID = other.id;
		font = font_regular1;
	...
	instance_create_layer(x,y,layer_get_id("Inst_healthui"),obj_health_sparetank_100);
