...
{
	sprite_index = spr_super_item_shockwave_extension
}
...
tex = 0
tex2 = 0
text1 = " SHOCKWAVE EXTENSION"
text2 = 0;
if (global.shockwave_available == 0)
{
	text2 = " ACTIVATES AFTER A SMALL DELAY. WHEN ACTIVE, SENDS OUT ELECTRICAL SHOCKWAVES THAT BLOCK ENEMY BULLETS, AND OPEN GREEN EYED GREY DOORS.  SELECT WITH " + string(L2) + "/" + string(R2) + " TO CYCLE BETWEEN ABILITIES, ACTIVATING THE CURRENT ONE HIGHLIGHTED. YOU CAN REFILL ALL AMMO BY USING SAVE (S) ROOMS.";
}
else text2 = " INCREASES SHOCKWAVE AMMO BY +3.";
