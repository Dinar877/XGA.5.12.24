...
xmin = (instance_place(x,y,obj_enemy_wormy_hitbox)).x;
xmax = xmin + (sprite_get_width(spr_wormy_hitbox)/2);
ymin = (instance_place(x,y,obj_enemy_wormy_hitbox)).y;
ymax = ymin + (sprite_get_height(spr_wormy_hitbox)/2);
