...
if (instance_place(x,y,obj_supernuclearblast_randomexplosion)) && (enemy_hurt <= 0)
{
	...
	if (hp < 70) && (hp >= 30) && (sprite_index != spr_super_nuclearblast_crystal2_1)
	{
		instance_create(random_range(bbox_left, bbox_right), random_range(bbox_top, bbox_bottom), obj_super_breakable_crystal_piece);
		instance_create(random_range(bbox_left, bbox_right), random_range(bbox_top, bbox_bottom), obj_super_breakable_crystal_piece);
		instance_create(random_range(bbox_left, bbox_right), random_range(bbox_top, bbox_bottom), obj_super_breakable_crystal_piece);
		
		sprite_index = spr_super_nuclearblast_crystal2_1
	}
	else if (hp < 30) && (sprite_index != spr_super_nuclearblast_crystal2_2)
	{
		instance_create(random_range(bbox_left, bbox_right), random_range(bbox_top, bbox_bottom), obj_super_breakable_crystal_piece);
		instance_create(random_range(bbox_left, bbox_right), random_range(bbox_top, bbox_bottom), obj_super_breakable_crystal_piece);
		instance_create(random_range(bbox_left, bbox_right), random_range(bbox_top, bbox_bottom), obj_super_breakable_crystal_piece);
		
		sprite_index = spr_super_nuclearblast_crystal2_2
	}
}
