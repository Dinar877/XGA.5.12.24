...
//which way
if (place_meeting(x,y,obj_enemy_missilebird_launcher_L))
{
	image_angle = 90
	sprite_index = spr_missilebird_fly_L
}
else if (place_meeting(x,y,obj_enemy_missilebird_launcher_R))
{
	image_angle = -90
	sprite_index = spr_missilebird_fly_R
}
...
inst2 = 0;
inst4 = 0;
inst2 = instance_place(x,y,obj_enemy_missilebird_hitbox);
inst_self = self;
...
emitter_vol = 0;
emitterSin = 0
audio_play_sound_on(global.inst_audio_emitterID[inst_n],snd_missile,true,1000, global.sfx_volume)
