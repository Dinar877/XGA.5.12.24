...
{
	audio_pause_sound(snd_missile)
	exit;	
}
else
{
	audio_resume_sound(snd_missile)	
}
...
xmin = (instance_place(x,y,obj_enemy_missilebird_hitbox)).x;
xmax = xmin + (sprite_get_width(sprite_width)/2);
ymin = (instance_place(x,y,obj_enemy_missilebird_hitbox)).y;
