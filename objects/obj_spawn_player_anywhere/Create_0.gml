...
{
	instance_create_layer(x,y,layer_get_id("Inst_healthui_mapborder"),obj_mapborder)




	instance_create_layer(x,y,layer_get_id("Inst_healthui"),obj_healthbar)
	instance_create_layer(x,y,layer_get_id("Inst_healthui"),obj_healthnumberone)
	instance_create_layer(x,y,layer_get_id("Inst_healthui"),obj_healthnumberten)

	instance_create_layer(x,y,layer_get_id("Inst_healthui"),obj_originalHP_block_start)
	instance_create_layer(x,y,layer_get_id("Inst_healthui"),obj_originalHP_block_start)
	instance_create_layer(x,y,layer_get_id("Inst_healthui"),obj_originalHP_block_start)
	instance_create_layer(x,y,layer_get_id("Inst_healthui"),obj_originalHP_block_start)
	instance_create_layer(x,y,layer_get_id("Inst_healthui"),obj_originalHP_block_start)
	...
	instance_create_layer(x,y,layer_get_id("Inst_healthui2"),obj_mapborder_underside)


	instance_create_layer(x,y,layer_get_id("Inst_level_0"),obj_player)
	instance_create_layer(x,y,layer_get_id("Inst_level_0"),object_player2_0_sprites)
	
	instance_create_layer(x,y,layer_get_id("Inst_level_0"),obj_link_audio)
	instance_create_layer(x,y,layer_get_id("Inst_level_0"),obj_save_manager)
	instance_create_layer(x,y,layer_get_id("Inst_level_0"),obj_load_manager)
	instance_create_layer(x,y,layer_get_id("Inst_level_0"),obj_player_spawnhere)




	instance_create_layer(x,y,layer_get_id("Instances_1"),obj_camera)
}
