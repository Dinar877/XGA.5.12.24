...
xmin = (instance_place(x,y,obj_enemy_fly_hitbox)).x;
xmax = xmin + (sprite_get_width(spr_fly)/2);
ymin = (instance_place(x,y,obj_enemy_fly_hitbox)).y;
ymax = ymin + (sprite_get_height(spr_fly)/2);
