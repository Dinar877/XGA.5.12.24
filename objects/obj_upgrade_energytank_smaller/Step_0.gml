...
&& (global.room_transition_nodoors = 0) && (global.room_transition_nodoors_2 = 0) && (global.room_transition_nodoors_more = 0)
{
	...
	if (global.healthtankN >= 3)
	{
		global.healthtankN = 0
		global.upgrade_health += 1;
		global.health_limit += 1;
		instance_create_layer(x,y,layer_get_id("Inst_healthui"),obj_originalHP_block);
	}
	
	text2 = " COLLECT 3 TO INCREASE YOUR HEALTH CAPACITY BY +1. CURRENT PROGRESS: " + string(global.healthtankN) + "/ 3.";
	text = text2
