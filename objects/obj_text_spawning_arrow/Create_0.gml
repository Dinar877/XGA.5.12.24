...
else if (instance_exists(obj_texty_generic))
{
...
else if (instance_exists(obj_texty_intro_xga))
{
	textyID = obj_texty_intro_xga
}
...
else if (instance_exists(obj_text_spawning_titleintro))
{
	spawnerID = obj_text_spawning_titleintro
}
else if (instance_exists(obj_text_spawning_trueintro_opening))
{
	spawnerID = obj_text_spawning_trueintro_opening
}
else if (instance_exists(obj_text_spawning_opening_1))
{
	spawnerID = obj_text_spawning_opening_1
}
else if (instance_exists(obj_text_spawning_midgame_npc_scientist)) ////////////// NPC'S
{
	spawnerID = obj_text_spawning_midgame_npc_scientist
}
else if (instance_exists(obj_text_spawning_npc_biocorpsoldier))
{
	spawnerID = obj_text_spawning_npc_biocorpsoldier
}
else if (instance_exists(obj_text_spawning_npc_scientist_1))
{
	spawnerID = obj_text_spawning_npc_scientist_1
}
else if (instance_exists(obj_text_spawning_npc_scientist_2))
{
	spawnerID = obj_text_spawning_npc_scientist_2
}
else if (instance_exists(obj_text_spawning_npc_scientist_3))
{
	spawnerID = obj_text_spawning_npc_scientist_3
}
else if (instance_exists(obj_text_spawning_endgame))
{
	spawnerID = obj_text_spawning_endgame
}
