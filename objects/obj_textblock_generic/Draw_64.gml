...
if (selected > 0)
{
	...
	else if (global.shockwave_state = 1)
	{
		if (shockwave> 0)
		{
			new_input_description = " S.SHOCK WAVES NOW OPEN GREY EYE METAL BARRIERS";
			draw_text_color(descrptX,descrptY,new_input_description,c_white,c_white,c_white,c_white,image_alpha)		
		}
	}
}