...
or (!instance_exists(obj_player_testing_collisions))
{
	exit;	
}
...
&& (global.climbing == 0) && (instance_exists(obj_mapchecker2)) && (instance_exists(obj_camera_stopperU)) && (instance_exists(obj_camera_stopperD))
{
	...
	{
		y = obj_player_testing_collisions.y-yshake;
	}
	
	yshake = lerp(yshake,-1,0.15);
	
	distance_to_border3 = obj_camera_testing_collisions.y-obj_camera_stopperU.y-90;
	distance_to_border4 = obj_camera_testing_collisions.y-obj_camera_stopperD.y+90;
...
//room border
if (instance_exists(obj_player_testing_collisions))
{
	//camera shift down, starting room transition
	if (obj_player_testing_collisions.y != y) && ((global.mapgrid_yZeroMove = 1) or (global.mapgrid_1x1 = 1)) && (global.room_transition_prep == 1)
	...
	&& (global.camera_shiftdown = 1) && (global.stopper_2ndscrnshot == 0)
	{
		...
		if (obj_player_testing_collisions.y > y)
		{
			y = lerp(y,obj_player_testing_collisions.y+2,0.2)
			with(obj_scrn_roomtransition)
			{
				y = obj_camera_testing_collisions.y-90;
			}
		}
		else if (obj_player_testing_collisions.y < y)
		{
			y = lerp(y,obj_player_testing_collisions.y-2,0.2)
			with(obj_scrn_roomtransition)
			{
	...
	&& (global.camera_shiftdown = 1) && (global.stopper_2ndscrnshot == 0)
	{
		...
		with(obj_scrn_roomtransition)
			{
				y = round(y)
				var ybob = y-obj_camera_testing_collisions.y+90
				var ybob2 = 0
			}
		global.ygridend = 0
		global.ygrid = 0
	...
	{
		collision_L = collision_rectangle(obj_camera_testing_collisions.x+170,obj_camera_testing_collisions.y+100,obj_camera_testing_collisions.x-170,obj_camera_testing_collisions.y-100,obj_camera_stopperL,false,true);
		collision_R = collision_rectangle(obj_camera_testing_collisions.x+170,obj_camera_testing_collisions.y+100,obj_camera_testing_collisions.x-170,obj_camera_testing_collisions.y-100,obj_camera_stopperR,false,true);
		collision_U = collision_rectangle(obj_camera_testing_collisions.x+170,obj_camera_testing_collisions.y+100,obj_camera_testing_collisions.x-170,obj_camera_testing_collisions.y-100,obj_camera_stopperU,false,true);
		collision_D = collision_rectangle(obj_camera_testing_collisions.x+170,obj_camera_testing_collisions.y+100,obj_camera_testing_collisions.x-170,obj_camera_testing_collisions.y-100,obj_camera_stopperD,false,true);
		...
		if (instance_exists(obj_camera_stopperL)) && (instance_exists(obj_camera_stopperR)) && (global.mapgrid_1x1 = 0) && (global.mapgrid_xZeroMove = 0)
		{
			...
			with(obj_camera_testing_collisions)
			{
				if !(global.climbing)
				{
					x = obj_player_testing_collisions.x;
				}
				
				distance_to_border = obj_camera_testing_collisions.x-obj_camera_stopperL.x-160;
				distance_to_border2 = obj_camera_testing_collisions.x-obj_camera_stopperR.x+159;
		...
		&& (global.room_transition_prep == 0)
		{
			...
			with(obj_camera_testing_collisions)
			{
				...
				{
					y = obj_player_testing_collisions.y-yspin-yshake-yshake2;
				}
				global.ygrid = 0
				distance_to_border3 = obj_camera_testing_collisions.y-obj_camera_stopperU.y-90;
				distance_to_border4 = obj_camera_testing_collisions.y-obj_camera_stopperD.y+90;
		...
		{
			x = obj_player_testing_collisions.x;
			y = obj_player_testing_collisions.y;
			xspin = 0;
			yspin = 0;
		}
