...
inst_player = collision_rectangle(id.x-200,id.y-32,id.x+200,id.y+32,obj_player, false,true);
...
xmin = (instance_place(x,y,obj_enemy_treespike_hitbox)).x;
xmax = xmin + (sprite_get_width(spr_treespike_idle)/2);
ymin = (instance_place(x,y,obj_enemy_treespike_hitbox)).y;
ymax = ymin + (sprite_get_height(spr_treespike_idle)/2);
