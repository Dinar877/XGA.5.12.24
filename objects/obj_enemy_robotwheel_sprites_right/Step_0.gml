//everything else
inst2 = instance_place(x,y,obj_enemy_robotwheel_hitbox_right)
...
//for getting killed
var xmin = (instance_place(x,y,obj_enemy_robotwheel_hitbox_right)).x;
var xmax = xmin + (sprite_get_width(spr_enemy_robotwheel1)/2);
var ymin = (instance_place(x,y,obj_enemy_robotwheel_hitbox_right)).y;
