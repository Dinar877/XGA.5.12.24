...
doors_touchingplayer_right(obj_door_normal_right_more, obj_door_normal_left_more, global.room_transition_more)
            ...
            with(obj_block2_door)
            {
                if (transition = 1) && (global.room_transition_prep = 0) && (global.room_transition = 0) && (global.room_transition1 = 0) && (global.room_transition_more = 0)
                {
                    with(obj_player)
                    {
						...
						{
							global.door_height = (obj_player.y+(global.jumpingdm*7))-obj_door_normal_right_more.y;
						}
						else global.door_height = (obj_player.y+(global.jumpingdm*7))-obj_door_normal_right_more.y;
...
doors_movingplayer_right(global.room_transition_more, global.doorpath5);
...
with(obj_scrn_roomtransition)
{
    if (FadeNow >= 1.0) && (global.room_transition_more = 1) && (global.room_x = 0) && (global.room_y = 1) && (global.stopper_2ndscrnshot = 0) && (global.mapgrid_1x1 == 0)
    {
        with(other)
        {
            ...
            if (x >= obj_camera.bbox_right + 29)
            {
                if (global.room_transition_notnowL_more = 0) && (global.room_transition_notnowL2 = 0) && (global.room_transition_notnowL1 = 0)
                {
