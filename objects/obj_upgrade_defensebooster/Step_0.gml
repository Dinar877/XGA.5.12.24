...
if (place_meeting(x,y,obj_player)) && (global.upgrade_process = 0)
{
	...
	*/
	...
	var tex2 = instance_create_layer(obj_camera.x-92-30,obj_camera.y,layer_get_id("Inst_healthui"),obj_texty_generic_upgrade);
	...
	var tex3 = instance_create_layer(obj_camera.x-92-30,obj_camera.y+16,layer_get_id("Inst_healthui"),obj_texty_generic_upgrade);

	with(tex3)
	{
		text = " CURRENT COMBINED BONUS : " + string(global.defense_booster*100) + "% REDUCTION. COLLECT A LOT OF THESE TO HAVE THEIR EFFECTS STACK TOGETHER.";
		spd = 1;
		spawnerID = other.id;
		font = font_regular1;
