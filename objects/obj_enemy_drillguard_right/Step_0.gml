...
if (inst_player > 0) && (sprite_index = spr_drillguard_idle_right)
{
	sprite_index = spr_drillguard_shoot_right
	image_index = 0
	audio_pause_sound(snd_drill)
}
else if (sprite_index = spr_drillguard_shoot_right) && (image_index == 11)
{
...
else if (sprite_index = spr_drillguard_shoot_right) && (image_index >= image_number-1)
{
	sprite_index = spr_drillguard_idle_right
	image_index = 0
