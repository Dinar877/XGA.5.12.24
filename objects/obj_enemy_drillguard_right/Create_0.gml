...
inst_block = instance_create(x-5,y-5,obj_block2)
inst_block2 = instance_create(x-5,y+11,obj_block2)
...
emitter_vol = 0;
emitterSin = 0
audio_play_sound_on(global.inst_audio_emitterID[inst_n],snd_drill,true,1000, global.sfx_volume)
