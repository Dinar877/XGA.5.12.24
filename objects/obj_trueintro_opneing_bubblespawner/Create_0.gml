...
emitter_vol = 0;
emitterSin = 0
audio_play_sound_on(global.inst_audio_emitterID[inst_n],snd_lab_ambience,true,1000, global.sfx_volume)
audio_play_sound_on(global.inst_audio_emitterID[inst_n],snd_heartbeat,true,1000, global.sfx_volume)
