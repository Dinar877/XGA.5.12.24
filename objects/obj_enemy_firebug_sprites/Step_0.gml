...
player_inrange_walk = collision_circle(id.x,id.y,250,obj_player,false,true)

//make sure block is not in the way of firing range
if (player_inrange) && (collision_line(id.x,id.y,id.x+(80*facing),id.y, obj_block,false,true))
{
	player_inrange = 0;
}
