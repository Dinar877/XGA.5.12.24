...
inst_ThdC = instance_create_depth(x,bbox_top,depth-1,obj_xga3_nanothunder_ceilingspark);
inst_ThdF = instance_create_depth(x,bbox_bottom+2,depth-1,obj_xga3_nanothunder_groundspark);