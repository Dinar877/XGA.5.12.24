...
else if (sprite_index == spr_cutscene_endgame_playertrapped_turningon) && (image_index >= image_number-1)
{
	...
	//pieces of sealers
	instance_create_layer(473,243,layer_get_id("Inst_doors"),obj_blockerdoor_piece)
	instance_create_layer(451,279,layer_get_id("Inst_doors"),obj_blockerdoor_piece)
	instance_create_layer(460,278,layer_get_id("Inst_doors"),obj_blockerdoor_piece)
	instance_create_layer(442,279,layer_get_id("Inst_doors"),obj_blockerdoor_piece)
	instance_create_layer(445,287,layer_get_id("Inst_doors"),obj_blockerdoor_piece)
	instance_create_layer(457,287,layer_get_id("Inst_doors"),obj_blockerdoor_piece)
	instance_create_layer(422,244,layer_get_id("Inst_doors"),obj_blockerdoor_piece)
	instance_create_layer(419,255,layer_get_id("Inst_doors"),obj_blockerdoor_piece)
	instance_create_layer(426,250,layer_get_id("Inst_doors"),obj_blockerdoor_piece)
	instance_create_layer(481,244,layer_get_id("Inst_doors"),obj_blockerdoor_piece)
	instance_create_layer(474,250,layer_get_id("Inst_doors"),obj_blockerdoor_piece)
	instance_create_layer(482,252,layer_get_id("Inst_doors"),obj_blockerdoor_piece)
	instance_create_layer(471,257,layer_get_id("Inst_doors"),obj_blockerdoor_piece)
	instance_create_layer(431,245,layer_get_id("Inst_doors"),obj_blockerdoor_piece)
	instance_create_layer(430,255,layer_get_id("Inst_doors"),obj_blockerdoor_piece)
	instance_create_layer(445,290,layer_get_id("Inst_doors"),obj_blockerdoor_piece)
	
	with(obj_blockerdoor_piece)
	{
		var randNum = (round(random_range(0,4)))
...
else if (sprite_index == spr_cutscene_endgame_playertrapped_escape) && (image_index >= image_number-1)
{
	...
	object_player2_0_sprites.x = 452
	object_player2_0_sprites.y = 309
