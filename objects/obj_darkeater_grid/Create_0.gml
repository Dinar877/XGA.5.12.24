...
//platforming variables + old pathfinding stuff
path = -1
...
{
	instance_create_depth(id.x,id.y,object_player2_0_sprites.depth-1,obj_darkeater_sprites)
}
...
/*
global.darkeater_grid = mp_grid_create(0,0,hcells,vcells,cell_width,cell_height)
