	...
	with(obj_player)
		{
			...
			if (global.camera_shiftdown == 0)
			{
				...
				{
				global.door_height = obj_camera.y-obj_door_border_right_2.y
				}
				else if (sprite_index = spr_player_jump)
				{
				global.door_height = obj_camera.y-obj_door_border_right_2.y-7
				}
			}
			else if (global.camera_shiftdown == 1)
			{
				if (sprite_index = spr_player)
				{
				global.door_height = obj_player.y-obj_door_border_right_2.y
				}
				else if (sprite_index = spr_player_jump)
				{
				global.door_height = obj_player.y-obj_door_border_right_2.y-7
				}
			}
