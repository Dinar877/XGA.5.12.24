...
//when layer touches inside far edge of door
doors_touchingplayer_left(obj_door_normal_left_more, obj_door_normal_right_more, global.room_transition_more);
            ...
            with(obj_block2_door)
            {
                if (transition = 1) && (global.room_transition_prep = 0) && (global.room_transition = 0) && (global.room_transition1 = 0) && (global.room_transition_more = 0)
                {
                    with(obj_player)
                    {
						...
						{
							global.door_height = (obj_player.y+(global.jumpingdm*7))-obj_door_normal_left_more.y;
						}
						else global.door_height = (obj_player.y+(global.jumpingdm*7))-obj_door_normal_left_more.y;
                        ...
                        if (global.room_transition_more = 0) && (global.room_y == 0) && (x1 = 1)
                        {
...
if (instance_exists(obj_door_normal_right_more))
{
		with(obj_door_normal_right_more)
            {
                if (global.room_y == 1) && (!place_meeting(x,y,obj_player)) && (global.room_transition_more = 0) && (backend == 0)
                {
                backend = 1;
                }
                else backend = 0;
...
if (stopper1 == 1) && (doit1 != 1) && (global.room_transition_more = 0)
{
    global.room_transition_more = 1;
    backend = 0;
    doit1 = 1;
}
...
with(obj_player)
{
    if (y == obj_door_normal_left.y+16) && (x == obj_door_normal_left.x) && (global.room_transition_more = 1)
    {
        instance_create(obj_room_transition_l2r3.x-227,y-80,obj_scrn_roomtransition);
    }
}

/*
if (global.room_transition_more == 0) && (stopper1 == 1)
{
        with(obj_scrn_roomtransition)
        {
        instance_destroy()
...
if (global.room_transition_more == 1) && (n == 0) && (stopper1 == 1) && (backend == 0)
{
...
doors_movingplayer_left(global.room_transition_more, global.doorpath6);
...
with(obj_scrn_roomtransition)
{
    if (FadeNow >= 1.0) && (global.room_transition_more = 1) && (global.room_x = 0) && (global.room_y = 1) && (global.stopper_2ndscrnshot = 0) && (global.mapgrid_1x1 == 0)
    {
        with(other)
        {
	...
	else if (FadeNow >= 1.0) && (global.room_transition_more = 1) && (global.room_x = 0) && (global.room_y = 1) && (global.stopper_2ndscrnshot = 0) && (global.mapgrid_1x1 == 1)
    {
        with(other)
        {
            if (backend = 0) && (stopper1 == 1)
