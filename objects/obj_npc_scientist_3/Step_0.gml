...
if (instance_exists(obj_player))
{
	...
	&& (obj_player.state != (Fall_shoot)) && (obj_player.state != (Jumping)) && (obj_player.state != (Falling)) && (obj_player.state != (Shooting))
	{
		...
		{
			spawningID = obj_text_spawning_npc_scientist_3	
		}
	...
	if (sprite_index = spr_scientist3_stand_left) && (obj_player.x > self.x)
	{
		sprite_index = spr_scientist3_turn_l2r;	
		image_index = 0
	}
	else if (sprite_index = spr_scientist3_turn_l2r) && (image_index >= image_number-1)
	{
		sprite_index = spr_scientist3_stand_right;	
	}

	if (sprite_index = spr_scientist3_stand_right) && (obj_player.x < self.x)
	{
		sprite_index = spr_scientist3_turn_r2l;	
		image_index = 0
	}
	else if (sprite_index = spr_scientist3_turn_r2l) && (image_index >= image_number-1)
	{
		sprite_index = spr_scientist3_stand_left;	
	}
}