...
if (surface11 != -1)
	{
		...
		var w = 320;
		var h = 180;
		scrn = sprite_create_from_surface(application_surface, 0, 0, w, h, false, false, 0, 0);
		...
		shader_set_uniform_f(time, timer2)
	
		var col = shader_get_uniform(shd_watery3,"col");
	    shader_set_uniform_f(col,0,0.25,0.5);
	
		draw_surface_part_ext(application_surface,0,0,w,h,0,0,1,1,c_white,1);
		surface_reset_target();
		shader_reset();
	
		draw_surface_ext(surface11,0,0,1,1,0,c_white,1.0)
		draw_self()
