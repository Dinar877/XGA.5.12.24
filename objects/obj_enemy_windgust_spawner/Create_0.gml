...
inst1 = instance_create_depth(x,y-10,id.depth+1,obj_enemy_windgust_wind)
inst2 = instance_create_depth(x,y-30,id.depth+1,obj_enemy_windgust_wind)
inst3 = instance_create_depth(x,y-50,id.depth+1,obj_enemy_windgust_wind)
inst4 = instance_create_depth(x,y-70,id.depth+1,obj_enemy_windgust_wind)
inst5 = instance_create_depth(x,y-90,id.depth+1,obj_enemy_windgust_wind)
inst6 = instance_create_depth(x,y-110,id.depth+1,obj_enemy_windgust_wind)
inst7 = instance_create_depth(x,y-130,id.depth+1,obj_enemy_windgust_wind)
