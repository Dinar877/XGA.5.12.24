...
borderdoors_touchingplayer_left()
	...
	with(obj_player)
		{
			...
			{
				global.door_height = obj_player.y-obj_door_border_left_3.y
			}
			else if (sprite_index = spr_player_jump)
			{
				global.door_height = obj_player.y-obj_door_border_left_3.y-7
			}
...
borderdoors_movingplayer_left(global.doorpath8)
...
if (started > 0)
{
	...
	{
	    if (FadeNow >= 1.0) 
		&& (global.room_transition_nodoors_3 = 1) && (global.room_x = 0) && (global.room_y = 1) && (global.stopper_2ndscrnshot = 0) && (global.mapgrid_1x1 == 0)
	    {
	        with(object_player2_0_sprites)
	        {
		...
		else if (FadeNow >= 1.0) && (global.room_transition_nodoors_3 = 1) && (global.room_x = 0) && (global.room_y = 1) && (global.stopper_2ndscrnshot = 0) && (global.mapgrid_1x1 == 1)
	    {
	        with(object_player2_0_sprites)
	        {
	            if (x + 304 > obj_camera_stopperR.x)
