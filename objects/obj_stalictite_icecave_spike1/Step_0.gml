...
if (!place_meeting(x,y+go1,obj_block)) && ((go1 > 0) or (gobullet1 > 0)) && (!place_meeting(x,y+go1,obj_enemy_stalker_sprites) && (!place_meeting(x,y+go1,obj_boss_bugspider_sprites)))
or (place_meeting(x,y,obj_stalactite_bugspidertriggerer_right)) or (place_meeting(x,y,obj_stalactite_bugspidertriggerer_left))
{
	go1 += 0.2;
	y += go1;
}
...
else if (place_meeting(x,y+go1,obj_boss_bugspider_sprites))
{
	audio_stop_sound(snd_rockimpact1)
	audio_stop_sound(snd_rockimpact2)
	audio_stop_sound(snd_rockimpact3)
	...
	with(instance_place(x,y+go1,obj_boss_bugspider_sprites))
	{
		if (warning > 0)
		{
			enemy_hurt = 0.9;
